...
SECRET_KEY = config("SECRET_KEY", default="unsafe-dev-key") #'django-insecure-$wk$f-g16=nh)ptvfij6jt2l^wpbb*kb1%)a!&rpqi&w0$r9$='
...
LOGGING = {
    ...
    "loggers": {
        "django": {
            "handlers": ["console"],
            "level": "INFO",  # change to DEBUG to see even more
        },
        "django.request": {
            "handlers": ["console"],
            "level": "INFO",
